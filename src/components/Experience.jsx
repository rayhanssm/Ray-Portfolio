...
const Experience = () => {
  ...
  return (
    <div name='experience'  className='w-full h-auto p-20 bg-[#002651] text-[#FEFEFE]'>
      <div className='flex flex-col justify-center items-center'>
        ...
        <div className={tab == 1 ? 'mt-8' : 'hidden'}>
          <div className='px-10 py-6 mb-20 border-2 rounded-md bg-gradient-to-b from-[#FEFEFE20] to-[#FEFEFE10]'>
            <div className='flex items-center gap-10 mb-6'>
              <img src={Exp1} alt="FILE Magazine Logo" style={{width: '150px'}}/>
              <div>
                <h1 className='text-xl font-black'>Director of Art</h1>
                <h1 className='text-l'>at FILE Magazine</h1>
            ...
            <div className='flex items-center gap-10 mb-6'>
              ...
              <div>
                <h1 className='text-xl font-black'>Activist and Staff</h1>
                <h1 className='text-l'>at Bina Nusantara Computer Club</h1>
            ...
            <div className='flex items-center gap-10 mb-6'>
              ...
              <div>
                <h1 className='text-xl font-black'>Front-End LnT Member</h1>
                <h1 className='text-l'>at Bina Nusantara Computer Club</h1>
            ...
            <div className='flex items-center gap-10'>
              <img src={Exp3} alt="BNCC LnT Logo" style={{width: '150px'}}/>
              <div>
                <h1 className='text-xl font-black'>Back-End LnT Member</h1>
                <h1 className='text-l'>at Bina Nusantara Computer Club</h1>
        ...
        <div className={tab == 2 ? 'mt-8' : 'hidden'}>
          <div className='flex flex-col items-left gap-10 px-10 py-6 mb-20 border-2 rounded-md bg-gradient-to-b from-[#FEFEFE20] to-[#FEFEFE10]'>
            <div className='flex items-center gap-10'>
              <img src={Edu1} alt="BINUS Logo" style={{width: '180px'}}/>
              <div>
                <h1 className='text-xl font-black'>Bina Nusantara University Jakarta</h1>
            ...
            <div className='flex items-center gap-10'>
              ...
              <div>
                <h1 className='text-xl font-black'>Kartini Vocational High School Batam</h1>
        ...
        <div className={tab == 3 ? 'mt-8' : 'hidden'}>
          <div className='grid grid-cols-2 gap-x-12 gap-y-10 px-10 py-6 mb-20 border-2 rounded-md bg-gradient-to-b from-[#FEFEFE20] to-[#FEFEFE10]'>
            <div className='flex flex-col justify-center items-center'>
              <img src={Skill1} alt="UI/UX Logo" style={{width: '100px'}} className='grayscale hover:grayscale-0 duration-200'/>
              <h1 className='font-black'>UI/UX</h1>
            </div>
            <div className='flex flex-col justify-center items-center'>
              <img src={Skill2} alt="HTML Logo" style={{width: '100px'}} className='grayscale hover:grayscale-0 duration-200'/>
              <h1 className='font-black'>HTML</h1>
            </div>
            <div className='flex flex-col justify-center items-center'>
              <img src={Skill3} alt="CSS Logo" style={{width: '100px'}} className='grayscale hover:grayscale-0 duration-200'/>
              <h1 className='font-black'>CSS</h1>
            </div>
            <div className='flex flex-col justify-center items-center'>
              <img src={Skill4} alt="JS Logo" style={{width: '100px'}} className='grayscale hover:grayscale-0 duration-200'/>
