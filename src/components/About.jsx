    ...
    <div name='about' className='w-full h-auto sm:px-6 bg-[#002651] text-[#FEFEFE] bg-gradient-to-b from-[#FEFEFE10]'>
      <div className='md:px-24 px-6 md:flex justify-around items-center h-screen'>
        <div className='pt-28 sm:w-[50%]'>
          ...
          <button onClick={() => openLink('https://drive.google.com/file/d/1g_e7TR27IlIAIcM-VSMlyo9KRupU7qk-/view')} className='border-2 rounded-md my-2 px-5 py-2  flex items-center hover:-translate-y-1 hover:scale-110 hover:bg-[#FF304F] hover:border-[#002651] hover:shadow-md duration-200'>View CV</button>
        </div>
